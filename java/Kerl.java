...
public class Kerl extends Curl {
    ...
    public static BigInteger convertBytesToBigInt(final byte[] bytes, final int offset, final int size) {

        return new BigInteger(Arrays.copyOfRange(bytes, offset, offset + size));
    }

    public static int[] convertBigintToTrits(final BigInteger value, int size) {
    ...
    public static byte[] convertBigintToBytes(final BigInteger value, int size) {
